...
Data structure this study were collected from the Demographic Health Survey (DHS) program. We used the STATCompiler from the DHS Program to develop customized table based on foucsing on water, transportation, and wealth indicators across more than 90 countries and across all time frame.


Both the waterpoint census and household surveys were undertaken by trained local enumerators and delivered in local languages, predominantly Swahili and Digo. Prior to data collection, research permits and approvals were obtained from the Government of Kenya's National Council of Science and Technology and the Central University Research Ethics Committee at the University of Oxford.
